              ...
              child: FloatingActionButton.extended(
                onPressed: () async {
                  ...
                  if (PlatformUtils.isAndroid) {
                    ...
                    // On Web/iOS, we don't have these specific Android permissions
                    hasPermission = true;
                  }
        ...
        builder: (ctx) {
          return SafeArea(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              if (isMedia && PlatformUtils.isAndroid)
                ListTile(
              ...
              ListTile(
                leading: const Icon(Icons.open_in_browser, color: Colors.blueGrey),
